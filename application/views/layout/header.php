...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url() ?>/assets/template/plugins/datatable/datatable.min.css">
  <link rel="stylesheet" href="<?= base_url() ?>/assets/template/plugins/datatable/buttons.min.css">
