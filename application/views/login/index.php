...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url() ?>"><b>E</b>-Rapot</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg mb-3">Masuk untuk memulai sesi Anda</p>
            <center>
                <span class="text-danger alert"><?= $this->session->flashdata('error'); ?></span>
            </center>
